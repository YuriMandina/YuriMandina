...
Sou um Assistente Administrativo Sênior (Ponto Focal Operacional) experiente em transição para o **Desenvolvimento de Software**. Com mais de 7 anos de experiência resolvendo problemas de negócios, estou agora canalizando essa lógica e eficiência para o desenvolvimento full-stack.

Meu foco é construir aplicações robustas e escaláveis que unam as necessidades administrativas às soluções técnicas.

- 🔭 **Projeto Atual:** Desenvolvendo <a href="https://github.com/YuriMandina/blindagem-juridica-ia" target="_blank">**juridical-shield-ai**</a>
...
- ⚡ **Offline:** Toco guitarra, canto e treino calistenia para manter mente e corpo afiados. 🎸🎤🤸🏻‍♂️
